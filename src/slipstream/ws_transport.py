...
def _parse_transaction_result_ws(msg: Dict[str, Any]) -> TransactionResult:
    ...
    return TransactionResult(
        ...
        commitment_level=msg.get("commitment_level"),
        confirmations=msg.get("confirmations"),
        slot_processed=msg.get("slot_processed"),
        slot_confirmed=msg.get("slot_confirmed"),
        slot_finalized=msg.get("slot_finalized"),
        timestamp=msg.get("timestamp", 0),
        routing=routing,
        error=error,
    )
